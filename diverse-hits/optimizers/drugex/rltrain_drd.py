...
df = pd.read_csv(f'{DATASETS_PATH}/fragbase.txt', header=None)  #test fragbase is drd2smiles
print(df.head())
...
#constraints
time_budget = 600 #10000 for sample constrain / 600 for time
...
#test needs frags
"""
generated = pretrained.generate(evaluator=env_drd, num_samples=100)
print(generated)
"""
